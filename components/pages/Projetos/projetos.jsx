...
export const Projetos = ({ image, title, description }) => {
  return (
    <div className="relative flex flex-col items-center justify-end shadow-md shadow-foreground rounded-2xl max-w-sm h-40 min-w-50 md:h-64 md:min-w-80 overflow-hidden hover:scale-105 hover:shadow-lg transition">
