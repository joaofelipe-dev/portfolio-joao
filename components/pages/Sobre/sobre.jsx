  ...
  return (
    <>
      ...
      <div className="relative w-full h-[213px] overflow-hidden">
        {/* Wave 1 */}
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 213" preserveAspectRatio="none">
          <path
      ...
      >
        ...
        <div
          className="absolute w-72 h-72 rounded-full pointer-events-none blur-3xl transition-transform duration-150"
          style={{
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 w-full max-w-6xl items-start">
        ...
        >
          <div className="flex items-center mb-4 sm:mb-6">
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl pr-2 text-foreground">Meu</h3>
        ...
        <motion.div
          ...
          >
          <div className=" flex items-center mb-4 sm:mb-6 ">
            <h3 className=" text-xl sm:text-2xl md:text-3xl lg:text-4xl pr-2 text-foreground ">Minha</h3>
            <h3 className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl`}>
              Jornada
            </h3>
          </div>
